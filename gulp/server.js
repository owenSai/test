...
gulp.task('reload', sequence(
    ['html:server', 'img:server', 'js:server', 'font:server']
));
...
const REG_STATIC = /\.(html|js|css|scss|png|gif|jpg|ttf|eot|svg|woff|map|json|ico)(\?.*)?(\#.*)?$/;
            ...
            function (req, res, next) {
                if (REG_STATIC.test(req.originalUrl)) {
                    ...
                    req.on("end", function () {
                        ...
                        let host="https://www.kcash.io";//ashare
                        // let host = "http://10.23.3.15:8381"; // qiangkezhen ip
